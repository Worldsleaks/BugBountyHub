...
* [Information Gathering](pentesting-web/information-gathering/README.md)
  ...
  * [Scanning Open Ports/Services](pentesting-web/information-gathering/scanning-open-ports-services.md)
  * [Subdomain Enumeration](pentesting-web/information-gathering/subdomain-enumeration/README.md)
    ...
    * [Subdomain Permutations](pentesting-web/information-gathering/subdomain-enumeration/subdomain-permutations.md)
  ...
  * [Endpoints](pentesting-web/information-gathering/endpoints.md)
...
* [Server-Side Vulnerabilities](pentesting-web/server-side-vulnerabilities/README.md)
  * [Path Traversal/File Inclusion](pentesting-web/server-side-vulnerabilities/path-traversal-file-inclusion.md)
  * [Access Control](pentesting-web/server-side-vulnerabilities/access-control.md)
  * [Authentication](pentesting-web/server-side-vulnerabilities/authentication.md)
  * [Server-side Request Forgery (SSRF)](pentesting-web/server-side-vulnerabilities/server-side-request-forgery-ssrf.md)
  ...
  * [SQL Injection](pentesting-web/server-side-vulnerabilities/sql-injection.md)
